...
object EasyTierTomlCodec {
    private const val DEFAULT_IPV4 = "10.0.0.1"
    private const val DEFAULT_HOSTNAME = "LocalViewer"
    ...
    fun build(config: EasyTierConfigUiState): String {
        ...
        appendTomlString(sb, "hostname", DEFAULT_HOSTNAME)
        appendTomlString(sb, "instance_name", DEFAULT_INSTANCE)
